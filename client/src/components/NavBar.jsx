...
export default function NavBar({ handleSelectFood }) {
    ...
    <Box>
      ...
      <Drawer isOpen={isOpen} placement="left" onClose={onClose}>
        ...
        <DrawerContent bg="gray.800" p="9" size="xs">
          ...
          <DrawerBody>
            <Button variant="ghost" color="white" leftIcon={<GiChickenOven />}>
    Carnes
  </Button>
  <Button variant="ghost" color="white" leftIcon={<GiFullPizza />}>
    Pastas
  </Button>
  <Button variant="ghost" color="white" leftIcon={<GiFishEggs />}>
    Pescados
  </Button>
  <Button variant="ghost" color="white" leftIcon={<TbSalad />}>
    Ensaladas
  </Button>
  <Button variant="ghost" color="white" leftIcon={<GiFrenchFries />}>
    Minutas
  </Button>
  ...
  <Button variant="ghost" color="white" leftIcon={<TbIceCream />}>
    Postres
  </Button></DrawerBody>
        </DrawerContent>
      </Drawer>
